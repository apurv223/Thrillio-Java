...
public class DataStore {
	...
	private static void loadBooks() {
		...
		bookmarks[2][1] = BookmarkManager.getInstance().createBook(4000, "Self-Reliance and Other Essays", "-",	1993	, "Dover Publications", new String[] { "Ralph Waldo Emerson"},BookGenre.PHILOSOPHY,4.5);
		bookmarks[2][2] = BookmarkManager.getInstance().createBook(4000, "Light From Many Lamps", "-",	1988	, "Touchstone", new String[] { "Lillian Eichler Watson"},BookGenre.PHILOSOPHY,5.0);
		bookmarks[2][3] = BookmarkManager.getInstance().createBook(4000, "Head First Design Patterns	Technical", "-",	2004	, "O'Reilly Media", new String[] { "Eric Freeman","Bert Bates","Kathy Sierra","Elisabeth Robson"},	BookGenre.TECHNICAL,4.5);
